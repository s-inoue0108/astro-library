...
<template>
    <div class="preview-tab">
        ...
        <ul class="buttons">
            <SvgButton title="Edit" :isLink="true"
                :linkUrl="`https://app.newt.so/si-library/apps/blog/models/article/contents/${_id}`" :isBlank="true"
                :fontWeight="500" :widthScale="3" :svgIconPath="svgPaths.penNib" :svgViewBox="svgViewBoxes.penNib" />
            <SvgButton title="KaTeX" :isLink="false" :svgIconPath="svgPaths.subscript"
                :svgViewBox="svgViewBoxes.subscript" :fontWeight="500" :widthScale="3" btnId="katex-editor-open-btn" />
        </ul>
    </div>
